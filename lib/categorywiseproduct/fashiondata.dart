...
import 'package:yourshop/fashionfulldetail.dart';
...
class Fashiondata extends StatefulWidget {
  @override
  _FashiondataState createState() => _FashiondataState();
}

class _FashiondataState extends State<Fashiondata> {
            ...
            children: <Widget>[
              Padding(
                ...
                child: Card(
                  child: Row(
                    children: <Widget>[
                      Text("Find Cloths in your nearby ",
                          style: TextStyle(
                              fontSize: 20,
                              color: Colors.black,
...
class FashiontilePage extends StatefulWidget {
  String title,
      description,
      image1Url,
      image2Url,
  ...
  @override
  _FashiontilePageState createState() =>
      _FashiontilePageState();
}

class _FashiontilePageState extends State<FashiontilePage> {
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      Fashionfulldetail(documentID: widget.documentId)));
        },
        child: Card(
          // color:Colors.black,
          elevation: 10,
