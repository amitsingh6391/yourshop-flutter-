...
class ElectronicTile extends StatefulWidget {
  String title,
      description,
      image1Url,
      image2Url,
  ...
  @override
  _ElectronicTileState createState() => _ElectronicTileState();
}

class _ElectronicTileState extends State<ElectronicTile> {
