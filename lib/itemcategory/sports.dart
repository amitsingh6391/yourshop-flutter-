...
class Sportsdataupload extends StatefulWidget {
  @override
  _SportsdatauploadState createState() => _SportsdatauploadState();
}

class _SportsdatauploadState extends State<Sportsdataupload> {
...
var userid;
  ...
  uploadBlog() async {
    if (selected2Image != null && selected1Image != null) {
      ...
      var sport1imageUrl = await (await tasks.onComplete).ref.getDownloadURL();
      print("this is url $sport1imageUrl");
      ...
      var sport2imageurl = await (await task.onComplete).ref.getDownloadURL();
      print("this is url $sport2imageurl");
      ...
      await Firestore.instance
          ...
          .document(documentID)
          .setData({
        "sport1imageurl": sport1imageUrl,
        "sport2imageurl": sport2imageurl,
        "contact": contact,
        "title": title,
        "desc": desc,
        "price": price,
...
.setData({
       ...
       "image1url":sport1imageUrl,
       "image2url":sport2imageurl,
        "contact":contact,
        "title": title,
        "desc": desc,
        "price":price,
