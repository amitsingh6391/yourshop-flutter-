...
class Phonedataupload extends StatefulWidget {
  @override
  _PhonedatauploadState createState() => _PhonedatauploadState();
}
...
class _PhonedatauploadState extends State<Phonedataupload> {
  ...
  uploadBlog() async {
    if (selected2Image != null && selected1Image != null) {
      ...
      var phone1imageUrl = await (await tasks.onComplete).ref.getDownloadURL();
      print("this is url $phone1imageUrl");
      ...
      var phone2imageurl = await (await task.onComplete).ref.getDownloadURL();
      print("this is url $phone2imageurl");
      ...
      await Firestore.instance
          ...
          .document(documentID)
          .setData({
        "phone1imageurl": phone1imageUrl,
        "phone2imageurl": phone2imageurl,
        "contact": contact,
        "title": title,
        "desc": desc,
        "price": price,
