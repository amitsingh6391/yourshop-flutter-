...
class Booksdataupload extends StatefulWidget {
  @override
  _BooksdatauploadState createState() => _BooksdatauploadState();
}

class _BooksdatauploadState extends State<Booksdataupload> {
...
var userid;
  ...
  uploadBlog() async {
    if (selected2Image != null && selected1Image != null) {
      ...
      var book1imageUrl = await (await tasks.onComplete).ref.getDownloadURL();
      print("this is url $book1imageUrl");
      ...
      var book2imageurl = await (await task.onComplete).ref.getDownloadURL();
      print("this is url $book2imageurl");
      ...
      await Firestore.instance
          ...
          .document(documentID)
          .setData({
        "book1imageurl": book1imageUrl,
        "book2imageurl": book2imageurl,
        "contact": contact,
        "title": title,
        "desc": desc,
        "price": price,
...
.setData({
       ...
       "image1url":book1imageUrl,
       "image2url":book2imageurl,
        "contact":contact,
        "title": title,
        "desc": desc,
        "price":price,
