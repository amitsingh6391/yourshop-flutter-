  ...
  uploadBlog() async {
    if (selected2Image != null && selected1Image != null) {
      ...
      print("this is url $bike2imageurl");
         ...
         await Firestore.instance.collection("bike").document(documentID).setData({

       "bike1imageurl":bike1imageUrl,
       "bike2imageurl":bike2imageurl,
        "contact":contact,
        "title": title,
        "desc": desc,
        "price":price,
                          ...
                          child: selected1Image != null
                              ...
                              : Padding(
                                ...
                                child: Card(
                                      ...
                                      child: Column(
                                        children: <Widget>[
                                          Text("Slect 1 image",style:TextStyle(color:Colors.white)),
                                          IconButton(
                              ...
                              : Padding(
                                ...
                                child: Card(
                                  ...
                                  elevation: 20,
                                      ...
                                      child: Column(
                                        children: <Widget>[
                                          Text("Slect 2 image ",style: TextStyle(color:Colors.white),),
                                          IconButton(
                                            tooltip: "take image from phone",
                                            color: Colors.white,
                                            icon: Icon(Icons.image),
